...
<header class="pc-header">
  <div class="m-header">
    ...
    {% endif %}
      ...
      <img src="{% static 'assets/images/logo-median.png' %}" alt="" class="logo logo-lg" style="width:185px;"/>
    </a>
    <!-- ======= Menu collapse Icon ===== -->
    <div class="pc-h-item">
  ...
  <ul class="list-unstyled">
        ...
        <div class="dropdown-header px-0 text-wrap header-notification-scroll position-relative"
          ...
          <div class="list-group list-group-flush w-100">
            ...
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="{% static 'assets/images/user/jokowi.jpg' %}" alt="user-image" class="user-avtar" />
                </div>
                <div class="flex-grow-1 ms-1">
                  <span class="float-end text-muted">2 min ago</span>
                  <h5>Pak Jokowi</h5>
                  <p class="text-body fs-6">Bang mabar free fire </p>
            ...
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="{% static 'assets/images/user/prabowo.jpg' %}" alt="user-image" class="user-avtar" />
                </div>
                <div class="flex-grow-1 ms-1">
                  <span class="float-end text-muted">10 min ago</span>
                  <h5>Pak Prabowo</h5>
                  <p class="text-body fs-6">Mending mabar pubg bang </p>
    ...
    <li class="dropdown pc-h-item header-user-profile">
      <a class="pc-head-link head-link-primary dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#"
        role="button" aria-haspopup="false" aria-expanded="false">
        <img src="{% static 'assets/images/logo-compact.png' %}" alt="user-image" class="user-avtar" />
        <span>
      ...
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
        <div class="dropdown-header">
          <h4>Good Morning, <span class="small text-muted"> Median Skill </span></h4>
          ...
          <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 280px)">
            <div class="upgradeplan-block bg-light-warning rounded">
              ...
              <a href="https://appseed.us/product/berry-dashboard/django/" target="_blank"
